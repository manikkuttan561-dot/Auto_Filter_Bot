...
API_ID = int(environ.get('API_ID', '24299597')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', 'd1a912c18e4544d5fd79a0c6790868fa')  # API Hash from my.telegram.org
BOT_TOKEN = environ.get('BOT_TOKEN', "8368497462:AAE5nwlAs1k 511M1FohhYG2re6wpmleHgoE")    # Bot token from @BotFather
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6821642850').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003871670590').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003499801068'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1003499801068'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1003499801068'))  # Premium logs channel id
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/HELANA_BOTZ')  # Support group link (make sure bot is admin)

# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1003593085370")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1003897159622")# Channels for force sub (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://kumarankoch_db_user:Z4RCW4RdnK7AYyoM@cluster0.a0k5iow.mongodb.net/?appName=Cluster0")  # MongoDB URI for the database
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1003881171563'))  # Notification of sent to your channel
...
TMDB_API_KEY = environ.get('TMDB_API_KEY', 'f2ecf3cd9ad48d2ae4c4fe5abf86a5ae') # preffer to use your own tmdb API Key get it from https://www.themoviedb.org/settings/api
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/HELANA_BOTZ') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/ShinasX') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/HELANA_BOTZ') # Update channel link for the bot
...
TMDB_ON_SEARCH = is_enabled((environ.get('TMDB_ON_SEARCH', "True")), False)    # Use TMDB Poster On Search Results
